document.addEventListener("DOMContentLoaded", function () {
    ...
    const backToDurationSelection = document.getElementById("backToDurationSelection");
    const toReview = document.getElementById("toReview");
    const backToLocationSelection = document.getElementById("backToLocationSelection");
        ...
        html += `
          <div class="product-card">
            ...
            <div class="product-info">
              ...
              <div class="product-price">&pound;${product.price.toFixed(2)}/hour</div>
    ...
    function setupEventListeners() {
      ...
      completeBooking.addEventListener('click', function() {
        if (!selectedDate || !selectedTime || !selectedDuration || !selectedLocation || !selectedProduct || !selectedPrice) {
        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(
            function(position) {
              ...
              dropoffLocation.value = `Current Location (${latitude.toFixed(4)}, ${longitude.toFixed(4)})`;
    ...
    function updateReviewDetails() {
      if (!selectedDate || !selectedTime || !selectedDuration || !selectedLocation || !selectedProduct || !selectedPrice) return;
